...
describe('layout switching', () => {
  ...
  it('toggles using LayoutSwitcher', () => { const change = vi.fn(); render(<LayoutSwitcher layout="mac-sidebar" onChange={change} />); fireEvent.click(screen.getByRole('button', { name: 'Switch to windows-navbar' })); expect(change).toHaveBeenCalledWith('windows-navbar') })
