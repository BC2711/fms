...
export const townsListConfig = createAdministrationPage('cities-and-towns', 'Cities and Towns', { field: 'district_id', label: 'District', endpoint: '/administration/districts' })
